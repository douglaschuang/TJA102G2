...
public class StaffVO implements java.io.Serializable {
	...
	public String toString() {
		return "StaffVO [staffId=" + staffId + ", account=" + account + ", " + "nickname=" + nickname + ", role="
				+ roleVO.getName() + ", " + "status=" + status + ", password=" + password + ", " + "updateDate="
				+ updateDate + "]";
	}
	...
	@NotEmpty(message = "密碼: 請勿空白", groups = CreateGroup.class)
