...
public class MvcViewConfig implements WebMvcConfigurer {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		// 會員儀表板
		registry.addViewController("/blog/full-grid-left").setViewName("frontend/blog-full-then-grid-left-sidebar");

		// 討論區
		registry.addViewController("/blog/standard-left").setViewName("frontend/blog-standard-left-sidebar");
